    ...
    return (
        <Carousel className="carouselContainer">
            <Carousel.Item className="carouselItem">
                <img src={cake1} className="carouselImg" />
                <Carousel.Caption className="carouselCaption">
                    <h3>Pistachio</h3>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item className="carouselItem">
                <img src={cake2} className="carouselImg" />
                <Carousel.Caption className="carouselCaption">
                    <h3>Fruits of the forest</h3>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item className="carouselItem">
                <img src={cake9} className="carouselImg" />
                <Carousel.Caption className="carouselCaption">
                    <h3>Fuits of the forest mini cakes</h3>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item className="carouselItem">
                <img src={cake3} className="carouselImg" />
                <Carousel.Caption className="carouselCaption">
                    <h3>Summer vibes</h3>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item className="carouselItem">
                <img src={cake5} className="carouselImg" />
                <Carousel.Caption className="carouselCaption">
                    <h3>Pomegranate and chia seeds</h3>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item className="carouselItem">
                <img src={cake6} className="carouselImg" />
                <Carousel.Caption className="carouselCaption">
                    <h3>Carrot</h3>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item className="carouselItem">
                <img src={cake7} className="carouselImg" />
                <Carousel.Caption className="carouselCaption">
                    <h3>Fuits pie</h3>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item className="carouselItem">
                <img src={cake4} className="carouselImg" />
                <Carousel.Caption className="carouselCaption">
                    <h3>Chocolate and peanut butter cupcake</h3>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item className="carouselItem">
                <img src={cake10} className="carouselImg" />
                <Carousel.Caption className="carouselCaption">
                    <h3>Brownie</h3>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item className="carouselItem">
                <img src={cake8} className="carouselImg" />
                <Carousel.Caption className="carouselCaption">
                    <h3>Wedding cake</h3>
                </Carousel.Caption>
            </Carousel.Item>
